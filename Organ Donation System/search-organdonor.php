...
<head>
    ...
    <title>Blood & Organ Donor Management System | Become A Donar</title>
...
<?php include('includes/header.php');?>
    ...
    <div class="container">
        ...
        <!-- Content Row -->
        <form name="organdonar" method="post">
<div class="row">
...
<div><select name="organtype" class="form-control" required>
...
$sql = "SELECT * from tblorgandonars where (status=:status and OrganType=:organtype) ||  (Address=:location)";
$query = $dbh -> prepare($sql);
...
{ ?>
            ...
            <div class="col-lg-4 col-sm-6 portfolio-item">
                <div class="card h-100">
                    <a href="#"><img class="card-img-top img-fluid" src="images/organ.png" alt="" ></a>
